...
class LiveJapan extends StatefulWidget {
  @override
  _LiveJapanState createState() => _LiveJapanState();
}

class _LiveJapanState extends State<LiveJapan> {
  var h2h;
  Future<Null> getUsers() async {
    try {
      final response = await http.get(
          'https://livescore-api.com/api-client/scores/live.json?competition_id=28&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
