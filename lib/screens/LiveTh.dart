...
class LiveTh extends StatefulWidget {
  @override
  _LiveThState createState() => _LiveThState();
}

class _LiveThState extends State<LiveTh> {
  var h2h;
  Future<Null> getUsers() async {
    try {
      final response = await http.get(
          'https://livescore-api.com/api-client/scores/live.json?competition_id=30&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
