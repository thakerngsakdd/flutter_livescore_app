...
class H2hEng extends StatefulWidget {
  @override
  _H2hEngState createState() => _H2hEngState();
}

class _H2hEngState extends State<H2hEng> {
  var h2h;
  Future<Null> getUsers() async {
    try {
      final response = await http.get(
          'https://livescore-api.com/api-client/scores/live.json?competition_id=2&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
