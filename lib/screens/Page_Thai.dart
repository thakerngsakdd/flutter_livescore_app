...
class PageThai extends StatefulWidget {
  @override
  PageThaiState createState() => PageThaiState();
}

class PageThaiState extends State<PageThai> {
  var matchth;
  Future<Null> getUsers() async {
    try {
      final response = await http.get(
          'https://livescore-api.com/api-client/fixtures/matches.json?competition_id=30&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
