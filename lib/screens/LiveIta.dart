...
class LiveIta extends StatefulWidget {
  @override
  _LiveItaState createState() => _LiveItaState();
}

class _LiveItaState extends State<LiveIta> {
  var h2h;
  Future<Null> getUsers() async {
    try {
      final response = await http.get(
          'https://livescore-api.com/api-client/scores/live.json?competition_id=4&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
