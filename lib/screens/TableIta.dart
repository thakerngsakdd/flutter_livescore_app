...
class TableIta extends StatefulWidget {
  @override
  _TableItaState createState() => _TableItaState();
}

class _TableItaState extends State<TableIta> {
  var h2h;
  Future<Null> getUsers() async {
    try {
      final response = await http.get(
          'https://livescore-api.com/api-client/leagues/table.json?competition_id=4&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
