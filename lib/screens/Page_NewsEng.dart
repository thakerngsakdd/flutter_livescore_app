...
class PageNewsEng extends StatefulWidget {
  @override
  _PageNewsEngState createState() => _PageNewsEngState();
}

class _PageNewsEngState extends State<PageNewsEng> {
  var users;
  Future<Null> getUsers() async {
    final response = await http.get(
        'http://newsapi.org/v2/top-headlines?country=gb&category=sports&apiKey=0825ae282b794daab385dd9137e5b9e2');
