...
class PageGer extends StatefulWidget {
  @override
  _PageGerState createState() => _PageGerState();
}

class _PageGerState extends State<PageGer> {
  var matchth;
  Future<Null> getUsers() async {
    final response = await http.get(
        'https://livescore-api.com/api-client/fixtures/matches.json?competition_id=1&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
