...
class PageJapan extends StatefulWidget {
  @override
  _PageJapanState createState() => _PageJapanState();
}

class _PageJapanState extends State<PageJapan> {
  var matchth;
  Future<Null> getUsers() async {
    final response = await http.get(
        'https://livescore-api.com/api-client/fixtures/matches.json?competition_id=28&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
