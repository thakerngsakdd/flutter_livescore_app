...
class LiveGer extends StatefulWidget {
  @override
  _LiveGerState createState() => _LiveGerState();
}

class _LiveGerState extends State<LiveGer> {
  var h2h;
  Future<Null> getUsers() async {
    try {
      final response = await http.get(
          'https://livescore-api.com/api-client/scores/live.json?competition_id=1&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
