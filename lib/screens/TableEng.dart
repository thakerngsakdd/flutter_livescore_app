...
class TableEng extends StatefulWidget {
  @override
  _TableEngState createState() => _TableEngState();
}

class _TableEngState extends State<TableEng> {
  var h2h;
  Future<Null> getUsers() async {
    try {
      final response = await http.get(
          'https://livescore-api.com/api-client/leagues/table.json?competition_id=2&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
