...
class TableJapan extends StatefulWidget {
  @override
  _TableJapanState createState() => _TableJapanState();
}

class _TableJapanState extends State<TableJapan> {
  var h2h;
  Future<Null> getUsers() async {
    try {
      final response = await http.get(
          'https://livescore-api.com/api-client/leagues/table.json?competition_id=28&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
