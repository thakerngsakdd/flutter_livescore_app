...
class TableSpain extends StatefulWidget {
  @override
  _TableSpainState createState() => _TableSpainState();
}

class _TableSpainState extends State<TableSpain> {
  var h2h;
  Future<Null> getUsers() async {
    try {
      final response = await http.get(
          'https://livescore-api.com/api-client/leagues/table.json?competition_id=3&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
