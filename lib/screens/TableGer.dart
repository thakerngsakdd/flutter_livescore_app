...
class TableGer extends StatefulWidget {
  @override
  _TableGerState createState() => _TableGerState();
}

class _TableGerState extends State<TableGer> {
  var h2h;
  Future<Null> getUsers() async {
    try {
      final response = await http.get(
          'https://livescore-api.com/api-client/leagues/table.json?competition_id=1&key=0hEdNJbQh6nJ7sTb&secret=x6oK7wRtPYREmLXm3CARlLHCS4mZxfb5');
